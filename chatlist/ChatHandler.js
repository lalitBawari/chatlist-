...
const chat_names = ["AMAN RANA", "AMIT SINGH BISHT", "RAHUL ", "SACHIN ADHIKARI", "ANKIT NAINWAL", "CHANDAN SINGH", "PAWAN BHAKRI","SURESH"];
const chat_names_length = chat_names.length;
const chat_msg = ["teri placement prepration kesi chl ri ",
    "Sun bhai ! pols aa gyi pols ",
    "50 rs kaat overacting ke",
    "kha busy rehta he bhai ","1 tera 1 mera , 2 tera 2 mera ","25 din me carorpati"," ye babu rao ka style he"];
const chat_msg_length = chat_msg.length;
const chat_img_length = 8;
